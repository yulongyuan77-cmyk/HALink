...
if __name__ == '__main__':
    ...
    TF2file = os.getcwd() + '/Dataset/Benchmark Dataset/STRING Dataset/' + data_type + '/TFs+' + str(
        args.num) + '/TF.csv'
    Gene2file = os.getcwd() + '/Dataset/Benchmark Dataset/STRING Dataset/' + data_type + '/TFs+' + str(
        args.num) + '/Target.csv'
    label_file = os.getcwd() + '/Dataset/Benchmark Dataset/STRING Dataset/' + data_type + '/TFs+' + str(
        args.num) + '/Label.csv'
    

    train_set_file = os.getcwd() + '/Dataset/Benchmark Dataset/STRING Dataset/' + data_type + '/TFs+' + str(
        args.num) + '/Train_set.csv'
    test_set_file = os.getcwd() + '/Dataset/Benchmark Dataset/STRING Dataset/' + data_type + '/TFs+' + str(
        args.num) + '/Test_set.csv'
    val_set_file = os.getcwd() + '/Dataset/Benchmark Dataset/STRING Dataset/' + data_type + '/TFs+' + str(
        args.num) + '/Validation_set.csv'
    path = os.getcwd() + '/Dataset/Benchmark Dataset/STRING Dataset/' + data_type + '/TFs+' + str(args.num)
